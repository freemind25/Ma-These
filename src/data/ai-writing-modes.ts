...
export const WRITING_MODES: WritingMode[] = [
  ...
  {
    id: "problematique",
    label: "Problématique de recherche",
    description: "Affinez votre question de départ et structurez votre problématique de recherche",
    icon: "Crosshair",
    category: "analysis",
    temperature: 0.5,
    placeholder: "Décrivez votre question de départ, votre objet de recherche ou votre thème exploratoire...",
    systemPrompt: "",
  },
  {
    id: "empirique",
    label: "Démarche empirique",
    description: "Concevez ou validez votre protocole de recherche empirique (collecte, échantillonnage, analyse)",
    icon: "BarChart3",
    category: "analysis",
    temperature: 0.4,
    placeholder: "Décrivez votre objet de recherche, votre méthodologie choisie ou vos données...",
    systemPrompt: "",
  },
  {
    id: "analyse",
    label: "Interprétation de résultats",
    description: "Interprétez vos résultats de recherche et articulez-les avec votre problématique",
    icon: "LineChart",
    category: "analysis",
    temperature: 0.5,
    placeholder: "Collez vos résultats (tableaux, statistiques, extraits d'entretiens) et décrivez votre problématique...",
    systemPrompt: "",
  },
  {
    id: "deep-research",
