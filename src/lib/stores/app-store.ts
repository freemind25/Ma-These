...
export const NAV_CATEGORY_META: Record<string, { label: string; icon: string }> = {
  "_pinned":     { label: "Principal", icon: "LayoutDashboard" },
  "redaction":   { label: "R\u00e9daction", icon: "PenTool" },
  "structure":   { label: "Structure & Planification", icon: "ListTree" },
  "recherche":   { label: "Recherche & Sources", icon: "Search" },
  "methodologie":{ label: "M\u00e9thodologie & V\u00e9rification", icon: "ShieldCheck" },
  "ia-outils":    { label: "IA & Outils", icon: "Sparkles" },
